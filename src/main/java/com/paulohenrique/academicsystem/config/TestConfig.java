...
import com.paulohenrique.academicsystem.entities.enums.StudentStatus;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Student student = new Student(null,"Paulo Henrique","paulo@gmail.com","71988882347","Ciência da Computação","1234",7.0,StudentStatus.ADIMPLENTE);
		
		Student student2 = new Student(null,"Amanda Estefane","amanda@gmail.com","71988882387","Direito","12345",7.0,StudentStatus.INADIMPLENTE);
		Student student3 = new Student (null, "Adilson Santos","adilson@gmail.com","71977778542","Ciência da Computação","5585",6.0,StudentStatus.ADIMPLENTE);
